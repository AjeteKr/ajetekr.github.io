...
export default function NewProject({ onAdd, onCancel }) {
    ...
    function handleSave() {
        ...
        if (enteredImage.trim() === '' || enteredTitle.trim() === '' || enteredDescription.trim() === '' || enteredDueDate.trim() === '' || enteredLink.trim() === '') {
            modal.current.open();
            return;
        }
        onAdd({
    ...
    return (
        <>
            ...
            <div className="w-[35rem] mt-16">
                ...
                <div>
                    <Input type="image" ref={image} label="Image" />
                    <Input type="text" ref={title} label="Title" />
                    <Input ref={description} label="Description" textarea />
                    <Input type="text" ref={link} label="Link On GitHub" />
